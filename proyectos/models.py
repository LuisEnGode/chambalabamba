...
class Project(BaseOrdenPublicado):
    ...
    def header_image(self):
        ...
        header = self.fotos.filter(publicado=True, is_header=True).order_by("orden", "id").first()
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["project"], condition=models.Q(is_header=True),
...
class ProjectPlacement(BaseOrdenPublicado):
    ...
    titulo_bloque = models.CharField(max_length=160, blank=True, default="Proyectos actuales")

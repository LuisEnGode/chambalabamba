...
class ContactoStatic(models.Model):
    ...
    blockquote_footer = models.CharField(max_length=100, default="Ecoaldea Chambalabamba")
    direccion = models.CharField(max_length=200, default="Via a Yamburara Alto, Vilcambamba, Ecuador")

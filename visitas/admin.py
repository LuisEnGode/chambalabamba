...
class GuidedVisitAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Logística", {"fields": (
            "ubicacion","punto_encuentro","duracion_minutos","cupo_maximo",
            "fecha_inicio","fecha_fin","horario_text","frecuencia_text"
        )}),
        ("Aportes y contacto", {"fields": (
            "aporte_text","organizador","organizador_url",
